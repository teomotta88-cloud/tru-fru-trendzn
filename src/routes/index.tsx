  ...
  const cards = [
    {
      ...
      icon: Zap,
      blurb: "Il momento in cui il morso rivela tutta la magia di Trü Frü: il crock irresistibile, la frutta vera e la perfetta combinazione con il cioccolato. Una celebrazione della golosità che mette il prodotto al centro della scena.",
    },
    {
      to: "/tru-world",
      label: "TRÜ WORLD",
      ...
      icon: TrendingUp,
      blurb: "Un universo visivo che valorizza l'iconico pack Trü Frü e tutto ciò che rappresenta: qualità premium, ingredienti reali ed esperienza indulgente. Il brand diventa protagonista, simbolo di piacere autentico e distintivo.",
    },
    {
      to: "/tru-people",
      label: "TRÜ PEOPLE",
      ...
      icon: Sparkles,
      blurb: "Persone curiose e fedeli a sé stesse che trovano equilibrio nei piccoli piaceri quotidiani. Per loro, concedersi un momento Trü Frü non è un'eccezione, ma parte di uno stile di vita consapevole e senza compromessi.",
    },
    {
      to: "/influencer",
