  ...
  const cards = [
    {
      ...
      icon: Zap,
      blurb: "Il momento in cui il morso rivela tutta la magia di Trü Frü: il crock irresistibile, la frutta vera e la perfetta combinazione con il cioccolato.",
    },
    {
      to: "/tru-world",
      label: "TRÜ WORLD",
      ...
      icon: TrendingUp,
      blurb: "Un universo visivo che valorizza l'iconico pack Trü Frü e tutto ciò che rappresenta: qualità premium, ingredienti reali ed esperienza indulgente.",
    },
    {
      to: "/tru-people",
      label: "TRÜ PEOPLE",
